...
const Hero = () => {
  ...
  // Removed demoThreads - using real data now
  const removedDemoThreads = useMemo(
    () => ({
      '1': [
        {
          id: '1-1',
          senderId: '1',
          content: 'Excited to get the team on Chatterly. Love how the UI feels! 👏',
        ...
        },
        {
          id: '1-2',
          senderId: 'self',
          content: 'Same here! The live presence indicators are my favourite part.',
      ...
      '2': [
        {
          id: '2-1',
          senderId: 'self',
          content: 'Did you get a chance to review the sprint board?',
        ...
        },
        {
          id: '2-2',
          senderId: '2',
          content: 'Yep! Left a couple of comments for tomorrow’s standup.',
      ...
      '3': [
        {
          id: '3-1',
          senderId: '3',
          content: 'Heads up — the ACME account just upgraded. I’ll share notes soon.',
